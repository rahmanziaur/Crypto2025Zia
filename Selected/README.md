...
**2.** Prove that $\mathbb{Z}_n$, under addition and multiplication modulo $n$, is a field if and only if $n$ is prime. Illustrate your proof by contrasting the multiplicative structure of $\mathbb{Z}_{11}$ (prime modulus) with $\mathbb{Z}_{12}$ (composite modulus). *(5 marks)*
